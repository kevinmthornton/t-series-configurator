...
$(function() {
	...
	this is where the magic happens. you assign the .draggable functionality to an element and jquery takes care of the rest
	*/
    ...
    function addBladeToChassis( $item ) {	  
	  $item.fadeOut(function() {
		...
		if($item[0].id != "optionalSoftware1" && $item[0].id != "optionalSoftware2") {
			...
			if($totalChassis >  12) {
				alert("Sorry, you can only fill this configuration with 12 blades or less.");
				return false;
			}
